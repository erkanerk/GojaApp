      ...
      <View style={styles.formWrapper}>
        <View style={styles.inputField}>
          <TextInput
            style={[
              styles.input,
              formErrors.emailErrorMessage ? styles.faultyInput : null,
            ]}
            value={email}
            placeholder={"Email"}
        ...
        <View style={styles.inputField}>
          <TextInput
            style={[
              styles.input,
              formErrors.usernameErrorMessage ? styles.faultyInput : null,
            ]}
            value={userName}
        ...
        <View style={styles.inputField}>
          <TextInput
            style={[
              styles.input,
              formErrors.passwordErrorMessage ? styles.faultyInput : null,
            ]}
            value={password}
